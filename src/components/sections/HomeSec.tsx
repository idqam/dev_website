  ...
  return (
    ...
    >
      <div className="text-center z-10 px-4">
        <h1 className="text-4xl sm:text-xl md:text-2xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-300 to-red-300 via-purple-300 bg-clip-text text-transparent leading-right">
          Hi! Im Owen
        </h1>
        <p className="text-gray-400 text-lg sm:text-sm mb-8 max-w-lg mx-auto">
